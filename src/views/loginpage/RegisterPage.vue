  ...
  <div>
    <el-card class="box-card">
      ...
      <el-form
        ...
        class="demo-ruleForm"
      >
      <el-form-item class="color1" label="email" prop="email" >
            <el-input
              type="email"
      ...
      <el-select v-model="ruleForm.checkgender" class="m3" placeholder="Male" size="large">
      <el-option
    ...
    <el-form-item class = "color1" label="Age" prop="checkage">
      <el-input-number class="age" v-model="ruleForm.checkage" :min="1" :max="120" @change="handleChange" />
    </el-form-item>
    <el-form-item class="color1" label="password" prop="password">
          ...
          <el-form-item class="color1" label="confirm password" prop="password2">
            <el-input
              :type="pwdType"
          ...
          <el-form-item class="color3" style="color: orange;" label="verification code" prop="verificationCode" type="primary">
            <div class="vertify">
              <el-input
